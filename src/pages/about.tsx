...
const about = () => {
  ...
  return (
    <>
      <Meta
        title="happy horseについて | 馬の売買プラットフォーム"
        ogpURL="https://www.happyhorse.xyz/about"
        description="happy horse（ハッピーホース）では、主に乗馬・馬術、レクレーションの馬の売買ができます。馬の販売・購入をより便利に、より手軽に。素敵な出会いがありますように。HAPPY UMA LIFE! "
