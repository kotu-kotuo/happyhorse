      ...
      <div className="termsContainer">
        <div className="termsSpace">
          ...
          <p className="termsText">
            この利用規約（以下，「本規約」といいます。）は，野々山諒（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
          </p>
        </div>
        <div className="termsSpace">
          <div className="termsLabel">第1条（適用）</div>
          <ol className="termsList">
            <li className="termsText">
        ...
        <div className="termsSpace">
          <div className="termsLabel">第2条（利用登録）</div>
          <ol className="termsList">
            <li className="termsText">
        ...
        {/* <div className="termsSpace">
          <div className="termsLabel">第4条（利用料金および支払方法）</div>
          <ol className="termsList">
            <li className="termsText">
        ...
        <div className="termsSpace">
          <div className="termsLabel">第4条（禁止事項）</div>
          <div className="termsText">
            ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。
          </div>
          <ol className="termsList">
            <li className="termsText">法令または公序良俗に違反する行為</li>
            <li className="termsText">犯罪行為に関連する行為</li>
            <li className="termsText">
            ...
            <li className="termsText">他のユーザーに成りすます行為</li>
            <li className="termsText">
            ...
            <li className="termsText">
              ...
              <ol className="termsList">
                <li className="termsText">過度に暴力的な表現</li>
                <li className="termsText">露骨な性的表現</li>
                <li className="termsText">
            ...
            <li className="termsText">宗教活動または宗教団体への勧誘行為</li>
            <li className="termsText">その他，当方が不適切と判断する行為</li>
          </ol>
        </div>
        <div className="termsSpace">
          <div className="termsLabel">第5条（本サービスの提供の停止等）</div>
          <ol className="termsList">
            <li className="termsText">
        ...
        <div className="termsSpace">
          <div className="termsLabel">第6条（著作権）</div>
          <ol className="termsList">
            <li className="termsText">
        ...
        <div className="termsSpace">
          <div className="termsLabel">第7条（利用制限および登録抹消）</div>
          <ol className="termsList">
            <li className="termsText">
        ...
        <div className="termsSpace">
          <div className="termsLabel">第8条（退会）</div>
          <div className="termsText">
            ユーザーは，当方の定める退会手続により，本サービスから退会できるものとします。
          </div>
        </div>
        <div className="termsSpace">
          <div className="termsLabel">第9条（保証の否認および免責事項）</div>
          <ol className="termsList">
            <li className="termsText">
        ...
        <div className="termsSpace">
          <div className="termsLabel">第14条（権利義務の譲渡の禁止）</div>
          <div className="termsText">
            ユーザーは，当方の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
          </div>
        </div>
        <div className="termsSpace">
          <div className="termsLabel">第15条（準拠法・裁判管轄）</div>
          <ol className="termsList">
            <li className="termsText">
